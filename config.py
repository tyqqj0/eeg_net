...
parser.add_argument('--feature_dim', type=int, default=64, help='the dim of each feature')
...
parser.add_argument('-data', metavar='DIR',
                    default='/content/gdrive/MyDrive/split_compositional_dominant_art_painting_target_sketch/data_t_1/PACS/',
...
# for lr decay epochs 在哪些epoch进行lr衰减
parser.add_argument('--epochs_decay', type=list, default=[24, 30],
                    help='weight lambda for second order moment loss')  # 这个是
